...
<form action="/login/insert" method="POST" id="signform">
        <div id="wrapper">
            ...
            <input type="button" id="find_addr" onclick="DaumPostcode()" value="우편번호 찾기" ><br>
...
$(function(){
	$("#id_check").click(function(){
		...
		$.ajax({url:"/login/idCheck", data:"id="+id, datatype:"text"}
		).done(function(data){
			if(data == ""){
        ...
        $("#mem_tel").on("input",function(){
            ...
            if(result != null){
               $(".mem_tel.regex").html("");  
                ...
                $(".mem_tel.regex").css("color","red").html("&emsp;&nbsp;올바른 번호가 아닙니다");
            }
