	...
	<header class="d-flex flex-wrap justify-content-center py-3 mb-4 border-bottom">
		<a href="/main"
			...
			<svg class="bi me-2" width="40" height="32">
				<use xlink:href="#bootstrap"></use></svg> <span class="fs-4" href="/main">Campy</span>
		</a>

		<ul class="nav nav-pills">
			<c:if test="${user.id != null }">
				<div class="dropdown">
					<a class="btn btn-secondary dropdown-toggle nav-link" type="button"
	...
	<form method="post" id="updateform" action="/noticeUpdateForm">
		...
		<table border="1">
			<tr>
				...
				<td><input name="not_title" value="${dto.not_title }" /> <input
					name="not_no" value="${dto.not_no}" type="hidden"></td>
			</tr>
			<tr>
