...
<div class="row">
	...
	<form action = "/mypage/memUpdateCheck" method = "post" id="privateInfo">
	<table>
		<tr> <td>이름</td><td><input value='${user.mem_name}' readonly style= "width : 300px"> </td> </tr>
		<tr> <td>주소</td><td><input value='${user.roadAddress}' readonly style= "width : 300px">  </td> </tr>
		<tr> <td>상세주소</td><td><input value='${user.detailAddress}' readonly style= "width : 300px"> </td> </tr>
		<tr> <td>전화번호</td><td><input value='${user.mem_tel}' readonly style= "width : 300px">  </td> </tr>
