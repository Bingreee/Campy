 	...
 	<section>
 		<div>
            ...
            <li>
                ...
                <label for="qna-2">예약은 어떻게 취소하나요?</label>
                <div>
                    <p>예약자 본인이 직접 예약확인/취소 가능합니다.</p>
                    <p>예약/결제 당시 안내된 취소/환불 규정에 따라 처리되며, 취소수수료가 발생 시 취소수수료를 차감한 금액으로 환불 처리됩니다.</p>
                </div>
            </li>
            <li>
                <input type="checkbox" id="qna-3">
                <label for="qna-3">입실일을 변경하고 싶어요</label>
                <div>
            ...
            <li>
                ...
                <label for="qna-4">객실타입(사이트) 변경하고 싶어요</label>
                <div>
            ...
            <li>
                ...
                <label for="qna-5">취소수수료 계산 기준은 어떻게되나요?</label>
                <div>
                    <p>취소수수료는 숙소별로 상이합니다.
취소수수료는 예약시점과는 무관하게 '입실일로부터 남은 날짜' 기준으로 부과됩니다.
결제금액에서 취소수수료를 차감한 금액으로 환불 처리됩니다.
환불 예정금액은 조회 시점 및 실제 환불 진행 시점에 따라 달라질 수 있으므로, 예약/결제 진행 당시 안내된 취소/환불 규정을 꼭 숙지해 주시길 바랍니다.</p>
...
<div>
 ...
 010-0000-0000평일 : 9:00 ~ 18:00(점심시간 12:00 ~ 1:00)
